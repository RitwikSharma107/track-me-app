...
public class NextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView pc = (TextView) findViewById(R.id.postalCodeId);
        pc.setText(intent.getStringExtra("Postal_Code"));

        TextView locality = (TextView) findViewById(R.id.localityId);
        locality.setText(intent.getStringExtra("Locality"));

        TextView d = (TextView) findViewById(R.id.districtId);
        d.setText(intent.getStringExtra("District"));

        TextView city = (TextView) findViewById(R.id.cityId);
        city.setText(intent.getStringExtra("City"));

        TextView state = (TextView) findViewById(R.id.stateId);
        state.setText(intent.getStringExtra("State"));

        TextView country = (TextView) findViewById(R.id.countryId);
        country.setText(intent.getStringExtra("Country_Name"));
    ...
    public void toPortfolio(View view){
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://ritwiksharma107.github.io/portfolio/"));
